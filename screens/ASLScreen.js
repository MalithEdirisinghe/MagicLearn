...
// import { View, Text, TouchableOpacity, StyleSheet, Image, Platform, Alert, ActivityIndicator, Modal } from 'react-native';
...
//         } else {
//             // Navigate to results or perform action for viewing results
//             navigation.navigate('LearnSign'); // Example navigation to Results screen
//         }
//         setImageUri(null);
...
//                 } else {
//                     console.log('Prediction result:', responseData.prediction);
...
//                     if (predictedLetter === actualLetter && predictedLetter !== undefined) {
