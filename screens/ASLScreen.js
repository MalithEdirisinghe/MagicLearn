...
//                 setResponseDataArray(prevArray => [...prevArray, responseData]); // Save response data to the array
...
//                     } else {
//                         Alert.alert('End of Range', 'You have reached the end of the selected range.');
//                         // Optionally, you can add logic to navigate back or handle the end of the range
//                     }
//                 }
//             } else {
