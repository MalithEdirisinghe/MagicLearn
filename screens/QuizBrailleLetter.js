...
const QuizScreen = ({ route, navigation }) => {
    ...
    const apiUrls = {
        "A to E": "http://13.60.250.75/blind/word/predict",
        "F to J": "http://13.60.250.75:2990/blind/word/fj/predict",
        "K to O": "http://13.60.250.75:2990/blind/word/ko/predict",
        "P to T": "http://13.60.250.75:2990/blind/word/pt/predict",
        "U to Z": "http://13.60.250.75:2990/blind/word/uz/predict"
    };
    ...
    const handleSubmitAnswer = async () => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                Alert.alert('Success', `Your answer has been submitted. Result: ${JSON.stringify(responseData)}`);
            } else {
